class ForumsController < ApplicationController
    ...
    def index
        ...
        json_response(results: {forums: all_forums, pinned_posts: Post.pins_json, per_page: @per_page, page: @page})
    end
    ...
    def show_by_forum
        forum = Forum.find_by(name: params[:forun])
        ...
        json_response(results: {forum: selected_forum, per_page: @per_page, page: @page})
    end
    ...
    def show_by_subforum
        ...
        new_subforum = {id: subforum.id, subforum: subforum.name, posts: subforum.subforum_posts(@per_page, @page)}
